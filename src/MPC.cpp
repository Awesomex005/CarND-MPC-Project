...
static AD<double> poly_derivative_eval(Eigen::VectorXd coeffs, AD<double> x) {
  AD<double> result = 0.0;
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    */
    ...
    for (unsigned int t = 1; t < N; t++) {
      ...
      AD<double> psides0 = CppAD::atan(poly_derivative_eval(coeffs, x0));
